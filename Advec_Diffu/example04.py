...
#
# Se resuelve el sistema usando un metodo de solucion de matriz dispersa
#
#Asparse = A.buildSparse(coef) # Construcción de la matriz en la memoria
#phi[1:-1] = spsolve(A,Su[1:-1])    # Para resolver el sistema lineal con matriz dispersa
